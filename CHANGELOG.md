...
- W3C MiniMapIcon and item icon
   ...
   - Do not want to initialize and enable , please Blizzard.eai set W3CIcons to false
...
- Add LocalizeOldTown , check now town whether it has been demolished
...
- (DevTools) Now can set back language to not English
