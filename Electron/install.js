...
exports.installOnDirectory = void 0;
const fs = require("fs");
...
const installOnDirectory = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (arrayOfFiles) {
        for (const file of arrayOfFiles) {
            ...
            try {
                ...
                const mpqEditor = spawnSync(`../MPQEditor.exe`, ['htsize', file, '64'], { encoding: 'utf8' });
                spawnSync('echo', [`MPQEditor ${file}`]);
                process.send(`MPQEditor ${file}`);
                const f1AddToMPQ = spawnSync(`../AddToMPQ.exe`, [
                    file,
                ...
                const f2AddToMPQ = spawnSync(`../AddToMPQ.exe`, [
                    file,
                    '..\\Scripts\\TFT\\elf.ai',
                    '..\\Scripts\\elf.ai',
                ...
                const f3AddToMPQ = spawnSync(`../AddToMPQ.exe`, [
                    file,
                    '..\\Scripts\\TFT\\elf2.ai',
                    '..\\Scripts\\elf2.ai',
...
exports.installOnDirectory = installOnDirectory;
(0, exports.installOnDirectory)();
