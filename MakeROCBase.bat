...
jassparser common.j Scripts\TFT\common.ai Scripts\ROC\elf.ai
ECHO _____________________________
...
jassparser common.j Scripts\TFT\common.ai Scripts\ROC\human.ai
ECHO _____________________________
...
jassparser common.j Scripts\TFT\common.ai Scripts\ROC\orc.ai
ECHO _____________________________
...
jassparser common.j Scripts\TFT\common.ai Scripts\ROC\undead.ai
ECHO _____________________________
