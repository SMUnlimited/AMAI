...
function BJDebugMsg takes string msg returns nothing
    ...
    loop
        ...
        set i = i + 1
        exitwhen i == bj_MAX_PLAYERS_AMAI
    endloop
endfunction
...
function TriggerRegisterAnyUnitEventBJ takes trigger trig, playerunitevent whichEvent returns nothing
    ...
    loop
        ...
        set index = index + 1
        exitwhen index == bj_MAX_PLAYER_SLOTS_AMAI
    endloop
endfunction
...
function GetPlayersByMapControl takes mapcontrol whichControl returns force
    ...
    loop
        ...
        exitwhen playerIndex == bj_MAX_PLAYER_SLOTS_AMAI
    endloop
    ...
    loop
        ...
        if (sourceForce==bj_FORCE_ALL_PLAYERS or IsPlayerInForce(Player(sourceIndex), sourceForce)) then
            ...
            loop
                ...
                exitwhen targetIndex == bj_MAX_PLAYER_SLOTS_AMAI
            endloop
        endif

        set sourceIndex = sourceIndex + 1
        exitwhen sourceIndex == bj_MAX_PLAYER_SLOTS_AMAI
    endloop
endfunction
...
function ShareEverythingWithTeamAI takes player whichPlayer returns nothing
    ...
    loop
        ...
        set playerIndex = playerIndex + 1
        exitwhen playerIndex == bj_MAX_PLAYERS_AMAI
    endloop
endfunction
    ...
    loop
        if (not bj_meleeDefeated[playerIndex]) then
            ...
            loop
                ...
                exitwhen opponentIndex == bj_MAX_PLAYERS_AMAI
            endloop
...
function MeleeExposeAllPlayers takes nothing returns nothing
    ...
    loop
        ...
        loop
            ...
            exitwhen playerIndex2 == bj_MAX_PLAYERS_AMAI
        endloop
...
function MeleeCrippledPlayerTimeout takes nothing returns nothing
    ...
    loop
        ...
        exitwhen playerIndex == bj_MAX_PLAYERS_AMAI
    endloop
    if (playerIndex == bj_MAX_PLAYERS_AMAI) then
        return
    endif
    ...
    loop
        if playerScore[index] != 0 then
            ...
            loop
                ...
                set index2 = index2 + 1
                exitwhen index2 == bj_MAX_PLAYERS_AMAI
            endloop
...
function MeleeInitPlayerSlots takes nothing returns nothing
    call TeamInitPlayerSlots(bj_MAX_PLAYERS_AMAI)
endfunction
