...
function Convert2Player takes string Comp, boolean all_allowed returns player
  ...
  loop
    exitwhen((CColor == GetPlayerColor(Player(j))) or (j > 12))
    set j = j + 1
    if (j > 12) then
...
function MapInit takes nothing returns nothing
  ...
  elseif language == "Chinese" then
    call DisplayToAll("|c0000ffff﻿这张地图包含AMAI和智能指挥模块|r")
    call DisplayToAll("|c0000ffff输入'CMD:Help'查看帮助信息|r")
    call DisplayToAll("|c0000ffff按下 ESC 打开控制台对话框|r")
    call DisplayToAll("|c0000ffff登陆 https://github.com/SMUnlimited/AMAI 查询更新和其他信息|r")
    call DisplayToAll("|c0000ffffAMAI作者是AIAndy, Zalamander, DKSlayer, Strategy Master|r")
    call DisplayToAll("|c0000ffff由Dr.Fan、Sheeryiro（武汉大学）汉化完成，由KeamSpring、Pixyy修改完善。|r")
  endif
...
function RegisterCommands takes nothing returns nothing
  ...
  call RegisterCommand("LANGUAGE", "Portuguese", "", 71, 7, -1, -1, "AI Setting", 0, "Language", 76, "Portuguese", 84, "Mudar idioma para portuguese.")
  call RegisterCommand("LANGUAGE", "Norwegian", "", 71, 8, -1, -1, "AI Setting", 0, "Language", 76, "Norwegian", 78, "Sett spruket til norsk.")
...
function initLanguageDeutsch takes nothing returns nothing
  ...
  call SaveStr(translation, StringHash(language), StringHash("AI Setting"), "AI Einstellungen")
  call SaveStr(translation, StringHash(language), StringHash("Chatter"), "Chatten")
  call SaveStr(translation, StringHash(language), StringHash("Turned On/Off Computer Chatter."), "Computer Chatten wurde an/ausgeschaltet.")
  call SaveStr(translation, StringHash(language), StringHash("Turned On/Off Debug Mode."), "Debug Modus wurde an/ausgeschaltet.")
  call SaveStr(translation, StringHash(language), StringHash("Turned On/Off Balancing Mode."), "Balance Modus wurde an/ausgeschaltet.")
  call SaveStr(translation, StringHash(language), StringHash("Show"), "Zeige")
  call SaveStr(translation, StringHash(language), StringHash("Current Strategy"), "Momentane Strategie")
  call SaveStr(translation, StringHash(language), StringHash("Showing current strategy."), "Ich zeige momentane Strategie an.")
  call SaveStr(translation, StringHash(language), StringHash("Strategy names"), "Strategienamen")
  call SaveStr(translation, StringHash(language), StringHash("Change Strategy"), "Ändere Strategie")
  call SaveStr(translation, StringHash(language), StringHash("Changes current strategy."), "Ich ändere die momentane Strategie.")
  call SaveStr(translation, StringHash(language), StringHash("Cancel Orders"), "Befehle löschen")
  call SaveStr(translation, StringHash(language), StringHash("All Orders"), "Alle Befehle")
  call SaveStr(translation, StringHash(language), StringHash("I have Canceled All commands you have given me so far."), "Ich habe alle Befehle gelöscht, die du mir bis jetzt gegeben hast.")
  call SaveStr(translation, StringHash(language), StringHash("Attack Orders"), "Angriffsbefehle")
  call SaveStr(translation, StringHash(language), StringHash("I have Canceled all Attack commands you have given me so far."), "Ich habe alle Angriffsbefehle gelöscht, die du mir bis jetzt gegeben hast.")
  call SaveStr(translation, StringHash(language), StringHash("Build Orders"), "Baubefehle")
  call SaveStr(translation, StringHash(language), StringHash("I have Canceled all Build commands you have given me so far."), "Ich habe alle Baubefehle gelöscht, die du mir bis jetzt gegeben hast.")
  call SaveStr(translation, StringHash(language), StringHash("Queue"), "Queuebefehle")
  call SaveStr(translation, StringHash(language), StringHash("I have Canceled all Queued commands you have given me so far."), "Ich habe alle Queuebefehle gelöscht, die du mir bis jetzt gegeben hast.")
  call SaveStr(translation, StringHash(language), StringHash("I will Stop any current Attack."), "Ich breche den momentanen Angriff ab.")
  call SaveStr(translation, StringHash(language), StringHash("I will not Attack Anything."), "Ich greife nichts an.")
  call SaveStr(translation, StringHash(language), StringHash("I will not Attack Creeps."), "Ich greife keine Creeps an.")
  call SaveStr(translation, StringHash(language), StringHash("I will not Attack Enemies."), "Ich greife keine Feinde an.")
  call SaveStr(translation, StringHash(language), StringHash("I will build Air2Air units now."), "Ich baue Luft-Luft-Einheiten.")
  call SaveStr(translation, StringHash(language), StringHash("I will build Air2Ground units now."), "Ich baue Luft-Boden-Einheiten.")
  call SaveStr(translation, StringHash(language), StringHash("I will build Ground2Air units now."), "Ich baue Boden-Luft-Einheiten.")
  call SaveStr(translation, StringHash(language), StringHash("I will build Ground2Ground units now."), "Ich baue Boden-Boden-Einheiten.")
  call SaveStr(translation, StringHash(language), StringHash("I will build farms now."), "Ich baue Farmen.")
  call SaveStr(translation, StringHash(language), StringHash("I will build towers now."), "Ich baue Türme.")
  call SaveStr(translation, StringHash(language), StringHash("I will Attack/Guard the location of current screen position."), "Ich greife an/verteidige die momentane Bildschirmposition.")
  call SaveStr(translation, StringHash(language), StringHash("I will Attack/Guard the currently selected unit."), "Ich greife an/verteidige die gewählte Einheit.")
  call SaveStr(translation, StringHash(language), StringHash("I will Attack/Guard the specified player."), "Ich greife an/verteidige den gewählten Spieler.")
  call SaveStr(translation, StringHash(language), StringHash("I have Started or Restarted your Queued commands."), "Ich habe die Befehlsqueue gestartet / erneut gestartet.")
  call SaveStr(translation, StringHash(language), StringHash("I have Paused your Queued commands."), "Ich habe die Befehlsqueue angehalten.")
  call SaveStr(translation, StringHash(language), StringHash("I have Unpaused your Queued commands."), "Ich habe die Befehlsqueue weiterlaufen lassen.")
  call SaveStr(translation, StringHash(language), StringHash("I have Removed your last Queued command."), "Ich habe den letzten Befehl in der Befehlsqueue gelöscht.")
  call SaveStr(translation, StringHash(language), StringHash("I have Queued the Attack/Guard location of current screen position."), "Ich habe den Angriff/die Verteidigung der momentanen Bildschirmposition in die Queue hinzugefügt.")
  call SaveStr(translation, StringHash(language), StringHash("I have Queued the currently selected unit to Attack/Guard."), "Ich habe den Angriff/die Verteidigung der gewählten Einheit in die Queue hinzugefügt.")
  call SaveStr(translation, StringHash(language), StringHash("Turned On/Off Automatic Strategy Change."), "Ich habe den automatischen Strategiewechsel an/ausgeschaltet.")
  call SaveStr(translation, StringHash(language), StringHash("Restrict"), "Einschränken")
  call SaveStr(translation, StringHash(language), StringHash("No Attacks"), "Kein Angriff")
  call SaveStr(translation, StringHash(language), StringHash("No Creep Attacks"), "Keine Creepangriffe")
  call SaveStr(translation, StringHash(language), StringHash("No Enemy Attacks"), "Keine Feindangriffe")
  call SaveStr(translation, StringHash(language), StringHash("Farms"), "Farmen")
  call SaveStr(translation, StringHash(language), StringHash("Towers"), "Türme")
  call SaveStr(translation, StringHash(language), StringHash("Current screen"), "Bildschirmposition")
  call SaveStr(translation, StringHash(language), StringHash("Selected unit"), "Gewählte Einheit")
  call SaveStr(translation, StringHash(language), StringHash("Towerrush (Orc only)"), "Towerrush (Nur Orks)")
  call SaveStr(translation, StringHash(language), StringHash("Start/Restart"), "Start / Neustart")
  call SaveStr(translation, StringHash(language), StringHash("No Strategy Change"), "Kein Strategiewechsel")
  call SaveStr(translation, StringHash(language), StringHash("Build"), "Bauen")
  call SaveStr(translation, StringHash(language), StringHash("Attack Here"), "Bildschirmposition angreifen")
  call SaveStr(translation, StringHash(language), StringHash("Unpause"), "Ende Pause")
  call SaveStr(translation, StringHash(language), StringHash("Undo"), "Rückgängig")
  call SaveStr(translation, StringHash(language), StringHash("Attack select"), "Gewählte Einheit angreifen")
  call SaveStr(translation, StringHash(language), StringHash("Air vs. Air"), "Luft-Luft")
  call SaveStr(translation, StringHash(language), StringHash("Air vs. Ground"), "Luft-Boden")
  call SaveStr(translation, StringHash(language), StringHash("Ground vs. Air"), "Boden-Luft")
  call SaveStr(translation, StringHash(language), StringHash("Ground vs. Ground"), "Boden-Boden")
endfunction
function initLanguageSwedish takes nothing returns nothing
  ...
  call SaveStr(translation, StringHash(language), StringHash("AI Setting"), "AI Inställningar")
  call SaveStr(translation, StringHash(language), StringHash("Chatter"), "Chat")
  call SaveStr(translation, StringHash(language), StringHash("Turned On/Off Computer Chatter."), "Stängde av / satte på dator chat.")
  call SaveStr(translation, StringHash(language), StringHash("Turned On/Off Debug Mode."), "Stängde av / satte på felsökningsmedelande.")
  call SaveStr(translation, StringHash(language), StringHash("Turned On/Off Balancing Mode."), "Stängde av / satte på balanseringsläge.")
  call SaveStr(translation, StringHash(language), StringHash("Show"), "Visa")
  call SaveStr(translation, StringHash(language), StringHash("Current Strategy"), "Aktuell strategi")
  call SaveStr(translation, StringHash(language), StringHash("Showing current strategy."), "Visar aktuell strategi.")
  call SaveStr(translation, StringHash(language), StringHash("Strategy names"), "Strateginamn")
  call SaveStr(translation, StringHash(language), StringHash("Change Strategy"), "Byt strategi")
  call SaveStr(translation, StringHash(language), StringHash("Changes current strategy."), "Byter aktuell strategi.")
  call SaveStr(translation, StringHash(language), StringHash("Cancel Orders"), "Avbryt order")
  call SaveStr(translation, StringHash(language), StringHash("All Orders"), "Alla ordrar")
  call SaveStr(translation, StringHash(language), StringHash("I have Canceled All commands you have given me so far."), "Jag har avbrutit alla kommandon.")
  call SaveStr(translation, StringHash(language), StringHash("Attack Orders"), "Anfallskommand")
  call SaveStr(translation, StringHash(language), StringHash("I have Canceled all Attack commands you have given me so far."), "Jag har avbrutit alla anfallskommandon.")
  call SaveStr(translation, StringHash(language), StringHash("Build Orders"), "Byggkommand")
  call SaveStr(translation, StringHash(language), StringHash("I have Canceled all Build commands you have given me so far."), "Jag har avbrutit alla byggkommandon.")
  call SaveStr(translation, StringHash(language), StringHash("Queue"), "Följdkommando")
  call SaveStr(translation, StringHash(language), StringHash("I have Canceled all Queued commands you have given me so far."), "Jag har avbrutit alla följdkommandon.")
  call SaveStr(translation, StringHash(language), StringHash("I will Stop any current Attack."), "Jag har avbrutit alla byggorder du gett hittills.")
  call SaveStr(translation, StringHash(language), StringHash("I will not Attack Anything."), "Jag har avbrutit alla följdkommando du gett mig hittills.")
  call SaveStr(translation, StringHash(language), StringHash("I will not Attack Creeps."), "Jag avbryter nuvarande anfall.")
  call SaveStr(translation, StringHash(language), StringHash("I will not Attack Enemies."), "Jag kommer inte anfalla något.")
  call SaveStr(translation, StringHash(language), StringHash("I will build Air2Air units now."), "Jag kommer bygga luft- mot luftenheter nu.")
  call SaveStr(translation, StringHash(language), StringHash("I will build Air2Ground units now."), "Jag kommer bygga luft- mot markenheter nu.")
  call SaveStr(translation, StringHash(language), StringHash("I will build Ground2Air units now."), "Jag kommer bygga mark- mot luftenheter nu.")
  call SaveStr(translation, StringHash(language), StringHash("I will build Ground2Ground units now."), "Jag kommer bygga mark- mot markenheter nu.")
  call SaveStr(translation, StringHash(language), StringHash("I will build farms now."), "Jag kommer bygga farms nu.")
  call SaveStr(translation, StringHash(language), StringHash("I will build towers now."), "Jag kommer bygga torn nu.")
  call SaveStr(translation, StringHash(language), StringHash("I will Attack/Guard the location of current screen position."), "Jag kommer anfalla/vakta nuvarande position av bilden.")
  call SaveStr(translation, StringHash(language), StringHash("I will Attack/Guard the currently selected unit."), "Jag kommer anfalla/vakta den aktuellt valda enheten.")
  call SaveStr(translation, StringHash(language), StringHash("I will Attack/Guard the specified player."), "Jag kommer anfalla/vakta den valda spelaren.")
  call SaveStr(translation, StringHash(language), StringHash("I have Started or Restarted your Queued commands."), "Jag har startat eller återställt dina följdkommando.")
  call SaveStr(translation, StringHash(language), StringHash("I have Paused your Queued commands."), "Jag har pausat dina följdkommando.")
  call SaveStr(translation, StringHash(language), StringHash("I have Unpaused your Queued commands."), "Jag har fortsatt med dina följdkommandon.")
  call SaveStr(translation, StringHash(language), StringHash("I have Removed your last Queued command."), "Jag har tagit bort ditt senaste följdkommando.")
  call SaveStr(translation, StringHash(language), StringHash("I have Queued the Attack/Guard location of current screen position."), "Jag har följdlagt en order att anfalla/vakta nuvarande bild.")
  call SaveStr(translation, StringHash(language), StringHash("I have Queued the currently selected unit to Attack/Guard."), "Jag har följdlagt en order att anfalla/vakta valda enheten.")
  call SaveStr(translation, StringHash(language), StringHash("Turned On/Off Automatic Strategy Change."), "Stängt av / satt på automatiskt strategibyte.")
  call SaveStr(translation, StringHash(language), StringHash("Restrict"), "Begränsa")
  call SaveStr(translation, StringHash(language), StringHash("No Attacks"), "Inga anfall")
  call SaveStr(translation, StringHash(language), StringHash("No Creep Attacks"), "Inga creep-attacker")
  call SaveStr(translation, StringHash(language), StringHash("No Enemy Attacks"), "Inga fiende-anfall")
  call SaveStr(translation, StringHash(language), StringHash("Farms"), "Farms")
  call SaveStr(translation, StringHash(language), StringHash("Towers"), "Torn")
  call SaveStr(translation, StringHash(language), StringHash("Current screen"), "Nuvarande bild")
  call SaveStr(translation, StringHash(language), StringHash("Selected unit"), "Vald enhet")
  call SaveStr(translation, StringHash(language), StringHash("Towerrush (Orc only)"), "Towerrush (Bara för Orc)")
  call SaveStr(translation, StringHash(language), StringHash("Start/Restart"), "Starta/Starta om")
  call SaveStr(translation, StringHash(language), StringHash("No Strategy Change"), "Inget strategibyte")
  call SaveStr(translation, StringHash(language), StringHash("Build"), "Bygg")
  call SaveStr(translation, StringHash(language), StringHash("Attack Here"), "Anfall bild")
  call SaveStr(translation, StringHash(language), StringHash("Unpause"), "Fortsätt")
  call SaveStr(translation, StringHash(language), StringHash("Undo"), "Ångra")
  call SaveStr(translation, StringHash(language), StringHash("attack select"), "Anfall vald")
  call SaveStr(translation, StringHash(language), StringHash("Air vs. Air"), "Luft mot. Luft")
  call SaveStr(translation, StringHash(language), StringHash("Air vs. Ground"), "Luft mot. Mark")
  call SaveStr(translation, StringHash(language), StringHash("Ground vs. Air"), "Mark mot. Luft")
  call SaveStr(translation, StringHash(language), StringHash("Ground vs. Ground"), "Mark mot. Mark")
endfunction
function initLanguageFrench takes nothing returns nothing
  ...
  call SaveStr(translation, StringHash(language), StringHash("AI Setting"), "Configuration de l'IA")
  call SaveStr(translation, StringHash(language), StringHash("Chatter"), "Discussion")
  call SaveStr(translation, StringHash(language), StringHash("Turned On/Off Computer Chatter."), "Permettre/Proscrire la discussion avec l'ordinateur.")
  call SaveStr(translation, StringHash(language), StringHash("Turned On/Off Debug Mode."), "Permettre/Proscrire le mode debogger .")
  call SaveStr(translation, StringHash(language), StringHash("Turned On/Off Balancing Mode."), "Permettre/proscire le mode d'équilibrage.")
  call SaveStr(translation, StringHash(language), StringHash("Show"), "Montrer")
  call SaveStr(translation, StringHash(language), StringHash("Current Strategy"), "Strategie actuelle")
  call SaveStr(translation, StringHash(language), StringHash("Showing current strategy."), "Montrer la strategie actuelle.")
  call SaveStr(translation, StringHash(language), StringHash("Strategy names"), "Noms des strategies")
  call SaveStr(translation, StringHash(language), StringHash("Change Strategy"), "Changer la strategie")
  call SaveStr(translation, StringHash(language), StringHash("Changes current strategy."), "Changer la strategie actuelle.")
  call SaveStr(translation, StringHash(language), StringHash("Cancel Orders"), "Annuler les ordres")
  call SaveStr(translation, StringHash(language), StringHash("All Orders"), "tous les ordres")
  call SaveStr(translation, StringHash(language), StringHash("I have Canceled All commands you have given me so far."), "J'ai annule tous les ordres que tu m'as donne auparavant.")
  call SaveStr(translation, StringHash(language), StringHash("Attack Orders"), "Les ordres d'attaques")
  call SaveStr(translation, StringHash(language), StringHash("I have Canceled all Attack commands you have given me so far."), "J'ai annule tous les ordres d'attaque que tu m'as donne auparavant.")
  call SaveStr(translation, StringHash(language), StringHash("Build Orders"), "les ordres de construction")
  call SaveStr(translation, StringHash(language), StringHash("I have Canceled all Build commands you have given me so far."), "J'ai annule tous les ordres de construction que tu m'as donne auparavant.")
  call SaveStr(translation, StringHash(language), StringHash("Queue"), "file d'attente")
  call SaveStr(translation, StringHash(language), StringHash("I have Canceled all Queued commands you have given me so far."), "J'ai annule tous les ordres dans la file d'attente que tu m'as donne auparavant.")
  call SaveStr(translation, StringHash(language), StringHash("I will Stop any current Attack."), "Je vais annuler toutes attaques actuelles.")
  call SaveStr(translation, StringHash(language), StringHash("I will not Attack Anything."), "Je vais attaqer personne.")
  call SaveStr(translation, StringHash(language), StringHash("I will not Attack Creeps."), "Je ne vais pas attquer de creep.")
  call SaveStr(translation, StringHash(language), StringHash("I will not Attack Enemies."), "Je ne vais pas attaquer d'ennemis.")
  call SaveStr(translation, StringHash(language), StringHash("I will build Air2Air units now."), "Je vais creer des unites air/air maintenant.")
  call SaveStr(translation, StringHash(language), StringHash("I will build Air2Ground units now."), "Je vais creer des unites air/sol maintenant.")
  call SaveStr(translation, StringHash(language), StringHash("I will build Ground2Air units now."), "Je vais creer des unites sol/air maintenant.")
  call SaveStr(translation, StringHash(language), StringHash("I will build Ground2Ground units now."), "Je vais creer des unites sol/sol maintenant.")
  call SaveStr(translation, StringHash(language), StringHash("I will build farms now."), "Je vais creer des fermes maintenant.")
  call SaveStr(translation, StringHash(language), StringHash("I will build towers now."), "Je vais creer des tourelles maintenant.")
  call SaveStr(translation, StringHash(language), StringHash("I will Attack/Guard the location of current screen position."), "Je vais attaquer/garder a la position actuelle de l'ecran.")
  call SaveStr(translation, StringHash(language), StringHash("I will Attack/Guard the currently selected unit."), "Je vais attaquer/garder cette unite selectionnee actuellement.")
  call SaveStr(translation, StringHash(language), StringHash("I will Attack/Guard the specified player."), "Je vais attaquer/garder ce joueur specifique.")
  call SaveStr(translation, StringHash(language), StringHash("I have Started or Restarted your Queued commands."), "J'ai commence ou recommence tes ordres dans la file d'attente.")
  call SaveStr(translation, StringHash(language), StringHash("I have Paused your Queued commands."), "J'ai mis en veille vos ordres dans la file d'attente.")
  call SaveStr(translation, StringHash(language), StringHash("I have Unpaused your Queued commands."), "J'ai repris vos ordres dans la file d'attente.")
  call SaveStr(translation, StringHash(language), StringHash("I have Removed your last Queued command."), "J'ai supprime vos derniers ordres dans la file d'attente.")
  call SaveStr(translation, StringHash(language), StringHash("I have Queued the Attack/Guard location of current screen position."), "J'ai mis dans la file d'attente l'attaque/la protection du lieu de l'ecran actuel.")
  call SaveStr(translation, StringHash(language), StringHash("I have Queued the currently selected unit to Attack/Guard."), "J'ai mis dans la file d'attente l'unite choisir a attaquer/garder.")
  call SaveStr(translation, StringHash(language), StringHash("Turned On/Off Automatic Strategy Change."), "Permettre/Proscire les changements automatiques de strategie.")
  call SaveStr(translation, StringHash(language), StringHash("Restrict"), "Restrictions")
  call SaveStr(translation, StringHash(language), StringHash("No Attacks"), "Pas d'attaques")
  call SaveStr(translation, StringHash(language), StringHash("No Creep Attacks"), "Pas d'attaques de creep")
  call SaveStr(translation, StringHash(language), StringHash("No Enemy Attacks"), "Pas d'attaques contre des ennemis")
  call SaveStr(translation, StringHash(language), StringHash("Farms"), "Fermes")
  call SaveStr(translation, StringHash(language), StringHash("Towers"), "Tourelles")
  call SaveStr(translation, StringHash(language), StringHash("Current screen"), "Position actuelle")
  call SaveStr(translation, StringHash(language), StringHash("Selected unit"), "L'unite selectionnee")
  call SaveStr(translation, StringHash(language), StringHash("Towerrush (Orc only)"), "Towerrush (Orc seulement)")
  call SaveStr(translation, StringHash(language), StringHash("No Strategy Change"), "Pas de changement de strategie")
  call SaveStr(translation, StringHash(language), StringHash("Start/Restart"), "Commencer/Recommencer")
  call SaveStr(translation, StringHash(language), StringHash("Build"), "Construire")
  call SaveStr(translation, StringHash(language), StringHash("Attack Here"), "Attaquer ici")
  call SaveStr(translation, StringHash(language), StringHash("Unpause"), "Reprise")
  call SaveStr(translation, StringHash(language), StringHash("Undo"), "Annuler")
  call SaveStr(translation, StringHash(language), StringHash("attack select"), "Attaque choisie")
  call SaveStr(translation, StringHash(language), StringHash("Air vs. Air"), "Air vs. Air")
  call SaveStr(translation, StringHash(language), StringHash("Air vs. Ground"), "Air vs. sol")
  call SaveStr(translation, StringHash(language), StringHash("Ground vs. Air"), "sol vs. Air")
  call SaveStr(translation, StringHash(language), StringHash("Ground vs. Ground"), "sol vs. sol")
endfunction
function initLanguageSpanish takes nothing returns nothing
  ...
  call SaveStr(translation, StringHash(language), StringHash("AI Setting"), "Opcion del AI")
  call SaveStr(translation, StringHash(language), StringHash("Chatter"), "Conversacion")
  call SaveStr(translation, StringHash(language), StringHash("Turned On/Off Computer Chatter."), "Se Activo/Desactivo la conversacion de la computadora.")
  call SaveStr(translation, StringHash(language), StringHash("Turned On/Off Debug Mode."), "Se Activo/Desactivo el mode de Depuracion.")
  call SaveStr(translation, StringHash(language), StringHash("Turned On/Off Balancing Mode."), "Se Activo/Desactivo el modo de balance.")
  call SaveStr(translation, StringHash(language), StringHash("Show"), "Mostrar")
  call SaveStr(translation, StringHash(language), StringHash("Current Strategy"), "Estrategia actual")
  call SaveStr(translation, StringHash(language), StringHash("Showing current strategy."), "Mostrando estrategia actual.")
  call SaveStr(translation, StringHash(language), StringHash("Strategy names"), "Nombres de estrategias")
  call SaveStr(translation, StringHash(language), StringHash("Change Strategy"), "Cambiar Estrategia")
  call SaveStr(translation, StringHash(language), StringHash("Changes current strategy.Cambiando the estrategia."), "")
  call SaveStr(translation, StringHash(language), StringHash("Cancel Orders"), "Cancelar Ordernes")
  call SaveStr(translation, StringHash(language), StringHash("All Orders"), "Todas las ordenes")
  call SaveStr(translation, StringHash(language), StringHash("I have Canceled All commands you have given me so far."), "He cancelado todos los comandos que me diste hasta ahora.")
  call SaveStr(translation, StringHash(language), StringHash("Attack Orders"), "Ordenes de Ataque")
  call SaveStr(translation, StringHash(language), StringHash("I have Canceled all Attack commands you have given me so far."), "He cancelado todos los comandos de ataque que me diste hasta ahora.")
  call SaveStr(translation, StringHash(language), StringHash("Build Orders"), " Ordenes de Construccion")
  call SaveStr(translation, StringHash(language), StringHash("I have Canceled all Build commands you have given me so far."), "He cancelado todos los comandos de construccion que me diste hasta ahora.")
  call SaveStr(translation, StringHash(language), StringHash("Queue"), "Comandos en la Cola")
  call SaveStr(translation, StringHash(language), StringHash("I have Canceled all Queued commands you have given me so far."), "He cancelado todos los comandos en la cola que me diste hasta ahora.")
  call SaveStr(translation, StringHash(language), StringHash("I will Stop any current Attack."), "Voy a detener todos los ataques.")
  call SaveStr(translation, StringHash(language), StringHash("I will not Attack Anything."), "No voy a atacar nada.")
  call SaveStr(translation, StringHash(language), StringHash("I will not Attack Creeps."), "No voy a atacar a los creeps.")
  call SaveStr(translation, StringHash(language), StringHash("I will not Attack Enemies."), "No voy a atacar a los enemigos")
  call SaveStr(translation, StringHash(language), StringHash("I will build Air2Air units now."), "Ahora voy a construir unidades Aire-Aire.")
  call SaveStr(translation, StringHash(language), StringHash("I will build Air2Ground units now."), "Ahora voy a construir unidades Aire-Tierra.")
  call SaveStr(translation, StringHash(language), StringHash("I will build Ground2Air units now."), "Ahora voy a construir unidades Tierra-Aire.")
  call SaveStr(translation, StringHash(language), StringHash("I will build Ground2Ground units now."), "Ahora voy a construir unidades Tierra-Tierra.")
  call SaveStr(translation, StringHash(language), StringHash("I will build farms now."), "Ahora voy a construir granjas.")
  call SaveStr(translation, StringHash(language), StringHash("I will build towers now."), "Ahora voy a construir torres.")
  call SaveStr(translation, StringHash(language), StringHash("I will Attack/Guard the location of current screen position."), "Voy a atacar/proteger el sector que actualmente esta en pantalla.")
  call SaveStr(translation, StringHash(language), StringHash("I will Attack/Guard the currently selected unit."), "Voy a atacar/proteger la unidad que esta seleccionada")
  call SaveStr(translation, StringHash(language), StringHash("I will Attack/Guard the specified player."), "Voy a atacar/proteger el jugador especificado.")
  call SaveStr(translation, StringHash(language), StringHash("I have Started or Restarted your Queued commands."), "He  comenzado o vuelto a comenzar tus comandos en cola.")
  call SaveStr(translation, StringHash(language), StringHash("I have Paused your Queued commands."), "He dejado en pausa tus comandos en cola.")
  call SaveStr(translation, StringHash(language), StringHash("I have Unpaused your Queued commands."), "Procedo a continuar tus comandos en cola.")
  call SaveStr(translation, StringHash(language), StringHash("I have Removed your last Queued command."), "He removido tu ultimo comando en cola")
  call SaveStr(translation, StringHash(language), StringHash("I have Queued the Attack/Guard location of current screen position."), "He dejado en Ia cola la orden para atacar/proteger la posición actual de la pantalla.")
  call SaveStr(translation, StringHash(language), StringHash("I have Queued the currently selected unit to Attack/Guard."), "He dejado en Ia cola la orden para atacar/proteger la unidad seleccionada.")
  call SaveStr(translation, StringHash(language), StringHash("Turned On/Off Automatic Strategy Change."), "Se activo/desactivo el cambio automatico de estrategia.")
  call SaveStr(translation, StringHash(language), StringHash("Restrict"), "Restringir")
  call SaveStr(translation, StringHash(language), StringHash("No Attacks"), "No Atacar")
  call SaveStr(translation, StringHash(language), StringHash("No Creep Attacks"), "No atacar a los Creeps")
  call SaveStr(translation, StringHash(language), StringHash("No Enemy Attacks"), "No atacar a los enemigos")
  call SaveStr(translation, StringHash(language), StringHash("Farms"), "Granjas")
  call SaveStr(translation, StringHash(language), StringHash("Towers"), "Torres")
  call SaveStr(translation, StringHash(language), StringHash("Current screen"), "Sector en Pantalla")
  call SaveStr(translation, StringHash(language), StringHash("Selected unit"), "Unidad Seleccionada")
  call SaveStr(translation, StringHash(language), StringHash("Towerrush (Orc only)"), "Usar Torres (Solo Orcos)")
  call SaveStr(translation, StringHash(language), StringHash("Start/Restart"), "Comenzar/Re-empezar")
  call SaveStr(translation, StringHash(language), StringHash("No Strategy Change"), "No cambiar de estrategia")
  call SaveStr(translation, StringHash(language), StringHash("Build"), "Construir")
  call SaveStr(translation, StringHash(language), StringHash("Attack Here"), "Atacar aqui")
  call SaveStr(translation, StringHash(language), StringHash("Unpause"), "Continuar")
  call SaveStr(translation, StringHash(language), StringHash("Undo"), "Deshacer")
  call SaveStr(translation, StringHash(language), StringHash("attack select"), "Atacar Seleccion")
  call SaveStr(translation, StringHash(language), StringHash("Air vs. Air"), "Aire contra Aire")
  call SaveStr(translation, StringHash(language), StringHash("Air vs. Ground"), "Aire contra Tierra")
  call SaveStr(translation, StringHash(language), StringHash("Ground vs. Air"), "Tierra contra Aire")
  call SaveStr(translation, StringHash(language), StringHash("Ground vs. Ground"), "Tierra contra Tierra")
endfunction
function initLanguageRomanian takes nothing returns nothing
  ...
  call SaveStr(translation, StringHash(language), StringHash("AI Setting"), "Setari AI")
  call SaveStr(translation, StringHash(language), StringHash("Chatter"), "Vorbire")
  call SaveStr(translation, StringHash(language), StringHash("Turned On/Off Computer Chatter."), "Schimba On/Off vorbirea computerului.")
  call SaveStr(translation, StringHash(language), StringHash("Turned On/Off Debug Mode."), "Schimba On/Off Debug Mode.")
  call SaveStr(translation, StringHash(language), StringHash("Turned On/Off Balancing Mode."), "Schimba On/Off Mod de echilibrare.")
  call SaveStr(translation, StringHash(language), StringHash("Show"), "Arata")
  call SaveStr(translation, StringHash(language), StringHash("Current Strategy"), "Strategia Curenta")
  call SaveStr(translation, StringHash(language), StringHash("Showing current strategy."), "Arata strategia curenta.")
  call SaveStr(translation, StringHash(language), StringHash("Strategy names"), "Nume de strategii")
  call SaveStr(translation, StringHash(language), StringHash("Change Strategy"), "Schimba Strategia")
  call SaveStr(translation, StringHash(language), StringHash("Changes current strategy."), "Schimba strategia curenta.")
  call SaveStr(translation, StringHash(language), StringHash("Cancel Orders"), "Anuleaza Comenzile")
  call SaveStr(translation, StringHash(language), StringHash("All Orders"), "Toate Comenzile")
  call SaveStr(translation, StringHash(language), StringHash("I have Canceled All commands you have given me so far."), "Am anulat toate comenzile date pina acum.")
  call SaveStr(translation, StringHash(language), StringHash("Attack Orders"), "Comenzile de Atac")
  call SaveStr(translation, StringHash(language), StringHash("I have Canceled all Attack commands you have given me so far."), "Am anulat toate comenzile de atac date pina acum.")
  call SaveStr(translation, StringHash(language), StringHash("Build Orders"), "Comenzile de constructii")
  call SaveStr(translation, StringHash(language), StringHash("I have Canceled all Build commands you have given me so far."), "Am anulat toate comenzile de construit date pina acum.")
  call SaveStr(translation, StringHash(language), StringHash("Queue"), "Sirul")
  call SaveStr(translation, StringHash(language), StringHash("I have Canceled all Queued commands you have given me so far."), "Am anulat tot sirul de comenzi date pina acum.")
  call SaveStr(translation, StringHash(language), StringHash("I will Stop any current Attack."), "Anulez orice atac pe care il fac.")
  call SaveStr(translation, StringHash(language), StringHash("I will not Attack Anything."), "Nu voi ataca nimic.")
  call SaveStr(translation, StringHash(language), StringHash("I will not Attack Creeps."), "Nu voi ataca neutrii.")
  call SaveStr(translation, StringHash(language), StringHash("I will not Attack Enemies."), "Nu voi ataca pe inamici.")
  call SaveStr(translation, StringHash(language), StringHash("I will build Air2Air units now."), "Voi face unitati Aer-Aer acum.")
  call SaveStr(translation, StringHash(language), StringHash("I will build Air2Ground units now."), "Voi face unitati Aer-Sol acum.")
  call SaveStr(translation, StringHash(language), StringHash("I will build Ground2Air units now."), "Voi face unitati Sol-Aer acum.")
  call SaveStr(translation, StringHash(language), StringHash("I will build Ground2Ground units now."), "Voi face unitati Sol-Sol acum.")
  call SaveStr(translation, StringHash(language), StringHash("I will build farms now."), "Voi face ferme acum.")
  call SaveStr(translation, StringHash(language), StringHash("I will build towers now."), "Voi construii turnuri acum")
  call SaveStr(translation, StringHash(language), StringHash("I will Attack/Guard the location of current screen position."), "Voi Ataca/Apara locul determinat de pozitia ecranului.")
  call SaveStr(translation, StringHash(language), StringHash("I will Attack/Guard the currently selected unit."), "Voi Ataca/Apara unitatea selectata de tine.")
  call SaveStr(translation, StringHash(language), StringHash("I will Attack/Guard the specified player."), "Voi Ataca/Apara jucatorul specificat.")
  call SaveStr(translation, StringHash(language), StringHash("I have Started or Restarted your Queued commands."), "Am Inceput sau am Reinceput sirul tau de comenzi.")
  call SaveStr(translation, StringHash(language), StringHash("I have Paused your Queued commands."), "Am pus pauza sirului de comenzi.")
  call SaveStr(translation, StringHash(language), StringHash("I have Unpaused your Queued commands."), "Am pornit sirul de comenzi.")
  call SaveStr(translation, StringHash(language), StringHash("I have Removed your last Queued command."), "Am scos ultima comanda din sir")
  call SaveStr(translation, StringHash(language), StringHash("I have Queued the Attack/Guard location of current screen position."), "Am adaugat in sir comanda sa Atac/Apar locul determinat de ecran.")
  call SaveStr(translation, StringHash(language), StringHash("I have Queued the currently selected unit to Attack/Guard."), "Am adaugat in sir comanda sa Atac/Apar unitatea selectata.")
  call SaveStr(translation, StringHash(language), StringHash("Turned On/Off Automatic Strategy Change."), "Schimba On/Off schimbarea de strategie automata.")
  call SaveStr(translation, StringHash(language), StringHash("Restrict"), "Restrictioneaza")
  call SaveStr(translation, StringHash(language), StringHash("No Attacks"), "Fara atacuri")
  call SaveStr(translation, StringHash(language), StringHash("No Creep Attacks"), "Fara atacuri asupra neutrilor")
  call SaveStr(translation, StringHash(language), StringHash("No Enemy Attacks"), "Fara atacuri asupra inamicilor")
  call SaveStr(translation, StringHash(language), StringHash("Farms"), "Ferme")
  call SaveStr(translation, StringHash(language), StringHash("Towers"), "Turnuri")
  call SaveStr(translation, StringHash(language), StringHash("Current screen"), "Ecranul Actual")
  call SaveStr(translation, StringHash(language), StringHash("Selected unit"), "Unitatea Selectata")
  call SaveStr(translation, StringHash(language), StringHash("Towerrush (Orc only)"), "Towerrush (numai Orc)")
  call SaveStr(translation, StringHash(language), StringHash("Start/Restart"), "Incepe/Reincepe")
  call SaveStr(translation, StringHash(language), StringHash("No Strategy Change"), "Fara schimbare de strategie")
  call SaveStr(translation, StringHash(language), StringHash("Build"), "Produ")
  call SaveStr(translation, StringHash(language), StringHash("Attack Here"), "Ataca Aici")
  call SaveStr(translation, StringHash(language), StringHash("Unpause"), "Start")
  call SaveStr(translation, StringHash(language), StringHash("Undo"), "Undo")
  call SaveStr(translation, StringHash(language), StringHash("attack select"), "Ataca Unitate")
  call SaveStr(translation, StringHash(language), StringHash("Air vs. Air"), "Aer vs. Aer")
  call SaveStr(translation, StringHash(language), StringHash("Air vs. Ground"), "Aer vs. Sol")
  call SaveStr(translation, StringHash(language), StringHash("Ground vs. Air"), "Sol vs. Aer")
  call SaveStr(translation, StringHash(language), StringHash("Ground vs. Ground"), "Sol vs. Sol")
endfunction
function initLanguageRussian takes nothing returns nothing
  ...
  call SaveStr(translation, StringHash(language), StringHash("AI Setting"), "Настройки AI")
  call SaveStr(translation, StringHash(language), StringHash("Chatter"), "Чат")
  call SaveStr(translation, StringHash(language), StringHash("Turned On/Off Computer Chatter."), "Включить / выключить чат компьютера.")
  call SaveStr(translation, StringHash(language), StringHash("Turned On/Off Debug Mode."), "Включить / выключить дебаг режим.")
  call SaveStr(translation, StringHash(language), StringHash("Turned On/Off Balancing Mode."), "Включить / выключить режим балансирования.")
  call SaveStr(translation, StringHash(language), StringHash("Show"), "Показать.")
  call SaveStr(translation, StringHash(language), StringHash("Current Strategy"), "Данная стратегия.")
  call SaveStr(translation, StringHash(language), StringHash("Showing current strategy."), "Показываю данную стратегию.")
  call SaveStr(translation, StringHash(language), StringHash("Strategy names"), "Названия стратегий")
  call SaveStr(translation, StringHash(language), StringHash("Change Strategy"), "Сменить стратегию.")
  call SaveStr(translation, StringHash(language), StringHash("Changes current strategy."), "Меняю стратегию.")
  call SaveStr(translation, StringHash(language), StringHash("Cancel Orders"), "Отменить приказы.")
  call SaveStr(translation, StringHash(language), StringHash("All Orders"), "Все приказы")
  call SaveStr(translation, StringHash(language), StringHash("I have Canceled All commands you have given me so far."), "Я отменил все приказы, которые ты мне давал.")
  call SaveStr(translation, StringHash(language), StringHash("Attack Orders"), "Атаковать.")
  call SaveStr(translation, StringHash(language), StringHash("I have Canceled all Attack commands you have given me so far."), "Я отменил все приказы атак, которые ты мне давал.")
  call SaveStr(translation, StringHash(language), StringHash("Build Orders"), "Строить.")
  call SaveStr(translation, StringHash(language), StringHash("I have Canceled all Build commands you have given me so far."), "Я отменил все приказы по поводу строительства, которые ты мне давал.")
  call SaveStr(translation, StringHash(language), StringHash("Queue"), "Очередь.")
  call SaveStr(translation, StringHash(language), StringHash("I have Canceled all Queued commands you have given me so far."), "Я отменил все приказы в очереди.")
  call SaveStr(translation, StringHash(language), StringHash("I will Stop any current Attack."), "Я прекращаю атаку.")
  call SaveStr(translation, StringHash(language), StringHash("I will not Attack Anything."), "Я никого не буду атаковать.")
  call SaveStr(translation, StringHash(language), StringHash("I will not Attack Creeps."), "Я не буду бить бомжей.")
  call SaveStr(translation, StringHash(language), StringHash("I will not Attack Enemies."), "Я не буду атаковать врагов.")
  call SaveStr(translation, StringHash(language), StringHash("I will build Air2Air units now."), "Я буду строить юнитов воздух-воздух теперь.")
  call SaveStr(translation, StringHash(language), StringHash("I will build Air2Ground units now."), "Я буду делать воздух-землю.")
  call SaveStr(translation, StringHash(language), StringHash("I will build Ground2Air units now."), "Я буду строить земля-воздух сейчас.")
  call SaveStr(translation, StringHash(language), StringHash("I will build Ground2Ground units now."), "Делаю землю-землю.")
  call SaveStr(translation, StringHash(language), StringHash("I will build farms now."), "Строю фермы.")
  call SaveStr(translation, StringHash(language), StringHash("I will build towers now."), "Строю башни.")
  call SaveStr(translation, StringHash(language), StringHash("I will Attack/Guard the location of current screen position."), "Буду охранять / атаковать данное положение экрана.")
  call SaveStr(translation, StringHash(language), StringHash("I will Attack/Guard the currently selected unit."), "Я буду атаковать / защищать выбранного юнита.")
  call SaveStr(translation, StringHash(language), StringHash("I will Attack/Guard the specified player."), "Я буду атаковать / защищать выбранного игрока.")
  call SaveStr(translation, StringHash(language), StringHash("I have Started or Restarted your Queued commands."), "Я начал выполнять очередь команд.")
  call SaveStr(translation, StringHash(language), StringHash("I have Paused your Queued commands."), "Я отложил приказы в очереди.")
  call SaveStr(translation, StringHash(language), StringHash("I have Unpaused your Queued commands."), "Я снова выполняю приказы в очереди.")
  call SaveStr(translation, StringHash(language), StringHash("I have Removed your last Queued command."), "Убрал последнею в очереди команду.")
  call SaveStr(translation, StringHash(language), StringHash("I have Queued the Attack/Guard location of current screen position."), "Приказание защищать / атаковать данное положение экрана в очереди.")
  call SaveStr(translation, StringHash(language), StringHash("I have Queued the currently selected unit to Attack/Guard."), "Приказание защищать / атаковать выбранного юнита в очереди.")
  call SaveStr(translation, StringHash(language), StringHash("Turned On/Off Automatic Strategy Change."), "Включил / выключил автоматический выбор стратегий.")
  call SaveStr(translation, StringHash(language), StringHash("Restrict"), "Запретить.")
  call SaveStr(translation, StringHash(language), StringHash("No Attacks"), "Не атаковать.")
  call SaveStr(translation, StringHash(language), StringHash("No Creep Attacks"), "Не атаковать крипов.")
  call SaveStr(translation, StringHash(language), StringHash("No Enemy Attacks"), "Не атаковать врагов.")
  call SaveStr(translation, StringHash(language), StringHash("Farms"), "Фермы")
  call SaveStr(translation, StringHash(language), StringHash("Towers"), "Башни")
  call SaveStr(translation, StringHash(language), StringHash("Current screen"), "Вид экрана")
  call SaveStr(translation, StringHash(language), StringHash("Selected unit"), "Выбр. юнит.")
  call SaveStr(translation, StringHash(language), StringHash("Towerrush (Orc only)"), "Товерраш (только для орка)")
  call SaveStr(translation, StringHash(language), StringHash("Start/Restart"), "Начать.")
  call SaveStr(translation, StringHash(language), StringHash("No Strategy Change"), "Не менять.")
  call SaveStr(translation, StringHash(language), StringHash("Build"), "Строить.")
  call SaveStr(translation, StringHash(language), StringHash("Attack Here"), "Атаковать тут.")
  call SaveStr(translation, StringHash(language), StringHash("Unpause"), "Снять с паузы.")
  call SaveStr(translation, StringHash(language), StringHash("Undo"), "Назад.")
  call SaveStr(translation, StringHash(language), StringHash("attack select"), "Выбор атаки.")
  call SaveStr(translation, StringHash(language), StringHash("Air vs. Air"), "Воздух-воздух.")
  call SaveStr(translation, StringHash(language), StringHash("Air vs. Ground"), "Воздух-земля.")
  call SaveStr(translation, StringHash(language), StringHash("Ground vs. Air"), "Земля-воздух.")
  call SaveStr(translation, StringHash(language), StringHash("Ground vs. Ground"), "Земля-земля.")
endfunction
...
function initLanguageNorwegian takes nothing returns nothing
  ...
  set dlgbutton_ai_only = "Ingen Commander"
  call SaveStr(translation, StringHash(language), StringHash("AI Setting"), "AI Innstillinger")
  call SaveStr(translation, StringHash(language), StringHash("Chatter"), "Chat")
  call SaveStr(translation, StringHash(language), StringHash("Turned On/Off Computer Chatter."), "Skru av / på computer chatting.")
  call SaveStr(translation, StringHash(language), StringHash("Turned On/Off Debug Mode."), "Skru av / på feilsøkingsmodus")
  call SaveStr(translation, StringHash(language), StringHash("Turned On/Off Balancing Mode."), "Skru av / på balanserings modus")
  call SaveStr(translation, StringHash(language), StringHash("Show"), "Vise")
  call SaveStr(translation, StringHash(language), StringHash("Current Strategy"), "Aktuell strategi")
  call SaveStr(translation, StringHash(language), StringHash("Showing current strategy."), "Viser aktuell strategi.")
  call SaveStr(translation, StringHash(language), StringHash("Strategy names"), "Strateginavn")
  call SaveStr(translation, StringHash(language), StringHash("Change Strategy"), "Bytt strategi")
  call SaveStr(translation, StringHash(language), StringHash("Changes current strategy."), "Bytter aktuell strategi.")
  call SaveStr(translation, StringHash(language), StringHash("Cancel Orders"), "Avbryt order")
  call SaveStr(translation, StringHash(language), StringHash("All Orders"), "Alle ordrer")
  call SaveStr(translation, StringHash(language), StringHash("I have Canceled All commands you have given me so far."), "Jeg har avbrutt alle kommandoer")
  call SaveStr(translation, StringHash(language), StringHash("Attack Orders"), "Angrepskommandoer")
  call SaveStr(translation, StringHash(language), StringHash("I have Canceled all Attack commands you have given me so far."), "Jeg har avbrutt alle angrepskommandoer.")
  call SaveStr(translation, StringHash(language), StringHash("Build Orders"), "Byggekommandoer")
  call SaveStr(translation, StringHash(language), StringHash("I have Canceled all Build commands you have given me so far."), "Jag har avbrutt alla byggekommandoer.")
  call SaveStr(translation, StringHash(language), StringHash("Queue"), "Følgekommandoer")
  call SaveStr(translation, StringHash(language), StringHash("I have Canceled all Queued commands you have given me so far."), "Jag har avbrutt alla Følgekommandoer.")
  call SaveStr(translation, StringHash(language), StringHash("I will Stop any current Attack."), "")
  call SaveStr(translation, StringHash(language), StringHash("I will not Attack Anything."), "")
  call SaveStr(translation, StringHash(language), StringHash("I will not Attack Creeps."), "")
  call SaveStr(translation, StringHash(language), StringHash("I will not Attack Enemies."), "")
  call SaveStr(translation, StringHash(language), StringHash("I will build Air2Air units now."), "")
  call SaveStr(translation, StringHash(language), StringHash("I will build Air2Ground units now."), "")
  call SaveStr(translation, StringHash(language), StringHash("I will build Ground2Air units now."), "")
  call SaveStr(translation, StringHash(language), StringHash("I will build Ground2Ground units now."), "")
  call SaveStr(translation, StringHash(language), StringHash("I will build farms now."), "")
  call SaveStr(translation, StringHash(language), StringHash("I will build towers now."), "")
  call SaveStr(translation, StringHash(language), StringHash("I will Attack/Guard the location of current screen position."), "")
  call SaveStr(translation, StringHash(language), StringHash("I will Attack/Guard the currently selected unit."), "")
  call SaveStr(translation, StringHash(language), StringHash("I will Attack/Guard the specified player."), "")
  call SaveStr(translation, StringHash(language), StringHash("I have Started or Restarted your Queued commands."), "")
  call SaveStr(translation, StringHash(language), StringHash("I have Paused your Queued commands."), "")
  call SaveStr(translation, StringHash(language), StringHash("I have Unpaused your Queued commands."), "")
  call SaveStr(translation, StringHash(language), StringHash("I have Removed your last Queued command."), "")
  call SaveStr(translation, StringHash(language), StringHash("I have Queued the Attack/Guard location of current screen position."), "")
  call SaveStr(translation, StringHash(language), StringHash("I have Queued the currently selected unit to Attack/Guard."), "")
  call SaveStr(translation, StringHash(language), StringHash("Turned On/Off Automatic Strategy Change."), "")
  call SaveStr(translation, StringHash(language), StringHash("Restrict"), "")
  call SaveStr(translation, StringHash(language), StringHash("No Attacks"), "")
  call SaveStr(translation, StringHash(language), StringHash("No Creep Attacks"), "")
  call SaveStr(translation, StringHash(language), StringHash("No Enemy Attacks"), "")
  call SaveStr(translation, StringHash(language), StringHash("Farms"), "")
  call SaveStr(translation, StringHash(language), StringHash("Towers"), "")
  call SaveStr(translation, StringHash(language), StringHash("Current screen"), "")
  call SaveStr(translation, StringHash(language), StringHash("Selected unit"), "")
  call SaveStr(translation, StringHash(language), StringHash("Start/Restart"), "")
  call SaveStr(translation, StringHash(language), StringHash("No Strategy Change"), "")
  call SaveStr(translation, StringHash(language), StringHash("Build"), "")
  call SaveStr(translation, StringHash(language), StringHash("Attack Here"), "")
  call SaveStr(translation, StringHash(language), StringHash("Unpause"), "")
  call SaveStr(translation, StringHash(language), StringHash("Undo"), "")
  call SaveStr(translation, StringHash(language), StringHash("attack select"), "")
  call SaveStr(translation, StringHash(language), StringHash("Air vs. Air"), "")
  call SaveStr(translation, StringHash(language), StringHash("Air vs. Ground"), "")
  call SaveStr(translation, StringHash(language), StringHash("Ground vs. Air"), "")
  call SaveStr(translation, StringHash(language), StringHash("Ground vs. Ground"), "")
endfunction
function initLanguageChinese takes nothing returns nothing
  set chat_no_ally = "我才不和你结盟呢"
  set dlghdr_choose_ally = "选择盟友"
  set dlghdr_choose_number = "选择队伍"
  set dlghdr_choose_player = "选择队友"
  set dlghdr_game_type = "选择游戏类型"
  set dlghdr_root = "选择指挥"
  set dlghdr_tribute_type = "选择资源类型"
  set dlghdr_tribute_amount = "选择资源数量"
  set dlgbutton_cancel = "取消"
  set dlgbutton_all = "全部"
  set dlgbutton_gold = "金子"
  set dlgbutton_lumber = "木材"
  set dlgbutton_tribute = "资源"
  set dlgbutton_commander = "指挥模式"
  set dlgbutton_no_human = "常规模式"
  set dlgbutton_ai_only = "智能模式"
  call SaveStr(translation, StringHash(language), StringHash("Chatter"), "聊天")
  call SaveStr(translation, StringHash(language), StringHash("Turned On/Off Computer Chatter."), "开/关电脑聊天")
  call SaveStr(translation, StringHash(language), StringHash("Turned On/Off Debug Mode."), "开/关侦察")
  call SaveStr(translation, StringHash(language), StringHash("Turned On/Off Balancing Mode."), "开/关平衡模式")
  call SaveStr(translation, StringHash(language), StringHash("Show"), "显示信息")
  call SaveStr(translation, StringHash(language), StringHash("Current Strategy"), "当前战术")
  call SaveStr(translation, StringHash(language), StringHash("Showing current strategy."), "显示当前战术")
  call SaveStr(translation, StringHash(language), StringHash("Strategy names"), "战术名称")
  call SaveStr(translation, StringHash(language), StringHash("Change Strategy"), "改变战术")
  call SaveStr(translation, StringHash(language), StringHash("Changes current strategy."), "改变当前战术")
  call SaveStr(translation, StringHash(language), StringHash("Cancel Orders"), "取消命令")
  call SaveStr(translation, StringHash(language), StringHash("All Orders"), "全部命令")
  call SaveStr(translation, StringHash(language), StringHash("I have Canceled All commands you have given me so far."), "我已经取消布置的全部命令")
  call SaveStr(translation, StringHash(language), StringHash("Attack Orders"), "攻击")
  call SaveStr(translation, StringHash(language), StringHash("I have Canceled all Attack commands you have given me so far."), "我已经取消布置的全部攻击命令")
  call SaveStr(translation, StringHash(language), StringHash("Build Orders"), "建设")
  call SaveStr(translation, StringHash(language), StringHash("I have Canceled all Build commands you have given me so far."), "我已经取消布置的全部建设命令")
  call SaveStr(translation, StringHash(language), StringHash("Queue"), "命令队列")
  call SaveStr(translation, StringHash(language), StringHash("I have Canceled all Queued commands you have given me so far."), "我已经取消布置的全部下一步命令")
  call SaveStr(translation, StringHash(language), StringHash("I will Stop any current Attack."), "我将停止当前的全部进攻")
  call SaveStr(translation, StringHash(language), StringHash("I will not Attack Anything."), "我不会攻击任何目的")
  call SaveStr(translation, StringHash(language), StringHash("I will not Attack Creeps."), "我不会攻击中立生物")
  call SaveStr(translation, StringHash(language), StringHash("I will not Attack Enemies."), "我不会攻击敌人")
  call SaveStr(translation, StringHash(language), StringHash("I will build Air2Air units now."), "我将训练空对空单们")
  call SaveStr(translation, StringHash(language), StringHash("I will build Air2Ground units now."), "我将训练空对地单位")
  call SaveStr(translation, StringHash(language), StringHash("I will build Ground2Air units now."), "我将训练地对空单位")
  call SaveStr(translation, StringHash(language), StringHash("I will build Ground2Ground units now."), "我将训练地对地单位")
  call SaveStr(translation, StringHash(language), StringHash("I will build farms now."), "我要建造农场了")
  call SaveStr(translation, StringHash(language), StringHash("I will build towers now."), "我要建造箭塔了")
  call SaveStr(translation, StringHash(language), StringHash("I will Attack/Guard the location of current screen position."), "我将攻击/防守当前位置")
  call SaveStr(translation, StringHash(language), StringHash("I will Attack/Guard the currently selected unit."), "我将攻击/防守选定单位")
  call SaveStr(translation, StringHash(language), StringHash("I will Attack/Guard the specified player."), "我将攻击/防守选定玩家")
  call SaveStr(translation, StringHash(language), StringHash("I have Started or Restarted your Queued commands."), "我已经布置或重新布置你的下一步行动")
  call SaveStr(translation, StringHash(language), StringHash("I have Paused your Queued commands."), "我已经暂停布置你的下一步行动")
  call SaveStr(translation, StringHash(language), StringHash("I have Unpaused your Queued commands."), "我已经开启布置给你下一步行动")
  call SaveStr(translation, StringHash(language), StringHash("I have Removed your last Queued command."), "我已经取消最后布置给你的下一步行动")
  call SaveStr(translation, StringHash(language), StringHash("I have Queued the Attack/Guard location of current screen position."), "我已经设定攻?防守当前位置为下一步行动")
  call SaveStr(translation, StringHash(language), StringHash("I have Queued the currently selected unit to Attack/Guard."), "我已经设定选择当前单位为下一步行动")
  call SaveStr(translation, StringHash(language), StringHash("Turned On/Off Automatic Strategy Change."), "开/关自动策略判断")
  call SaveStr(translation, StringHash(language), StringHash("Restrict"), "限制")
  call SaveStr(translation, StringHash(language), StringHash("No Attacks"), "无攻击")
  call SaveStr(translation, StringHash(language), StringHash("No Creep Attacks"), "无中立生物攻击")
  call SaveStr(translation, StringHash(language), StringHash("No Enemy Attacks"), "无敌人攻击")
  call SaveStr(translation, StringHash(language), StringHash("Farms"), "农场")
  call SaveStr(translation, StringHash(language), StringHash("Towers"), "箭塔")
  call SaveStr(translation, StringHash(language), StringHash("Current screen"), "当前地点")
  call SaveStr(translation, StringHash(language), StringHash("Selected unit"), "选择单位")
  call SaveStr(translation, StringHash(language), StringHash("Towerrush (Orc only)"), "塔RUSH")
  call SaveStr(translation, StringHash(language), StringHash("Start/Restart"), "开始/重新开始")
  call SaveStr(translation, StringHash(language), StringHash("No Strategy Change"), "按计划行动")
  call SaveStr(translation, StringHash(language), StringHash("Build"), "建造")
  call SaveStr(translation, StringHash(language), StringHash("Attack Here"), "攻击")
  call SaveStr(translation, StringHash(language), StringHash("Unpause"), "继续")
  call SaveStr(translation, StringHash(language), StringHash("Undo"), "重做")
  call SaveStr(translation, StringHash(language), StringHash("attack select"), "攻击选择")
  call SaveStr(translation, StringHash(language), StringHash("Air vs. Air"), "空对空")
  call SaveStr(translation, StringHash(language), StringHash("Air vs. Ground"), "空对地")
  call SaveStr(translation, StringHash(language), StringHash("Ground vs. Air"), "地对空")
  call SaveStr(translation, StringHash(language), StringHash("Ground vs. Ground"), "地对地")
endfunction
